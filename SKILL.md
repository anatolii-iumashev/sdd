...
Базовый паттерн работы — **две сессии**: в одной сессии пишем сжатую спецификацию, в чистой сессии скармливаем её кодинг-агенту. Компактный RFC — это весь контекст, который получает исполнитель: без шума и истории переписки.
